...
import com.benmu.widget.view.calendar.format.MonthArrayTitleFormatter;
import com.benmu.widget.view.calendar.format.TitleFormatter;
import com.benmu.widget.view.calendar.format.WeekDayFormatter;
...
//                adapter.setDateSelected(today, true);
    ...
    /**
     * Set a {@linkplain com.prolificinteractive.materialcalendarview.format.TitleFormatter} using
